...
class PromptTemplates:
    ...
    Each method returns either a system or user prompt template for different
    stages of the research workflow (search result analysis, Reddit analysis,
    and synthesis).
    """
...
def create_message_pair(system_prompt: str, user_prompt: str) -> list[Dict[str, Any]]:
    ...
    Returns:
        List containing system and user message dictionaries for chat models.
    """
    return [
